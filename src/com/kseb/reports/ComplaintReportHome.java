...
@WebServlet("/viewcomplaintreport")
public class ComplaintReportHome extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			out.print("<html><head>");
			out.print("<title>Complaint Report</title>");
			out.print("<link rel='stylesheet' type='text/css' href='css/complaintreport.css'></head>");
			out.print("<body>");
			out.print("<div id='heading'><b>COMPLAINT REPORT</b></div>");
			out.print("<div id='formdiv'>");
			out.print("<form name='complaintreportform' id='complaintreportform' action='viewcompreport'>");
