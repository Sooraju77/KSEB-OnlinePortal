...
public class PaymentReportHome extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			out.print("<link rel='stylesheet' type='text/css' href='css/paymentreport.css'></head>");
			out.print("<body>");
			out.print("<div id='heading'><b>PAYMENT REPORT</b></div>");
			out.print("<div id='formdiv'>");
			out.print("<form name='paymentreportform' id='paymentreportform' action='displaypaymentreport'>");
